...
We observe that the numpy array is pointing nowhere as the original buffer was freed on the c++ side.\hypertarget{md_readme_autotoc_md14}{}\doxysubsection{Demo2}\label{md_readme_autotoc_md14}
Apart from the source module in {\ttfamily demo2.\+py} there\textquotesingle{}s a html file in the docs directory which includes sample outputs of the script\+: {\itshape docs/demo2.\+html}. 