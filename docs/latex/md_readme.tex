...
Python $>$= 3.\+9 numpy $>$= 1.\+23.\+4 g++ $>$= 9.\+3.\+0 G\+NU Make $>$= 4.\+2.\+1\hypertarget{md_readme_autotoc_md2}{}\doxysection{Installation}\label{md_readme_autotoc_md2}
Zur Installation führt man den \textquotesingle{}make\textquotesingle{} Befehl im Root-\/\+Verzeichnis des Projektes aus. \begin{DoxyVerb}user@HOST:~/cpp2np$ make
\end{DoxyVerb}


Das cpp2np Modul wird automatisch gebaut und im environment installiert.\hypertarget{md_readme_autotoc_md3}{}\doxysection{Problem mit setup.\+py}\label{md_readme_autotoc_md3}
...
Dazu führt man folgenden Befehl im Root-\/\+Verzeichnis des Projektes aus\+: \begin{DoxyVerb}user@HOST:~/cpp2np$ echo export LD_LIBRARY_PATH=$(pwd)/build/lib.linux-x86_64-cpython-310 >> ~/.bashrc
\end{DoxyVerb}
\hypertarget{md_readme_autotoc_md4}{}\doxysection{Demo}\label{md_readme_autotoc_md4}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{>>> pointer, shape = c2n.array\_2x2()}
